...
| SQL Crack | [marketplace.visualstudio.com](https://marketplace.visualstudio.com) | VS Code extension that visualizes SQL as interactive flow diagrams using local AST parsing. |
| PostgreSQL (MS) | [marketplace.visualstudio.com](https://marketplace.visualstudio.com) | Official Microsoft VS Code extension with object explorer, IntelliSense, and Copilot integration. |
