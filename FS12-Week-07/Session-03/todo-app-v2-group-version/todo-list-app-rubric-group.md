# Group Todo List App - Assessment Rubric

## Project Overview

This rubric evaluates the Todo List App project based on advanced JavaScript concepts, DOM manipulation, event handling, form processing, and local storage.

Do this in a group of 2 only. No more.
