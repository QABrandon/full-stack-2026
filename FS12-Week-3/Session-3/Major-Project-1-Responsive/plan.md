...
2. Grab some inspiration from other pages (i.e. https://github.com/emmabostian/developer-portfolios)
   1. Open Dev Tools
   2. Go to Device Mode
...
3. Mock up of our site
   - excalidraw.com / paper / paint / adobe
   - figma.com
...
9. Suggest doing mobile > tablet > Desktop for each main section of your site
   ...
   - don't forget about potentially testing in https://responsively.app/
     for faster feedback
